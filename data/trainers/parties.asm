...
CarrieGroup:
	...
	tr_mon 100, STARMIE @ SHELL_BELL
		...
		tr_moves THUNDER_WAVE, SURF, DAZZINGLEAM, RECOVER
	...
	tr_mon 100, STEELIX @ WEAK_POLICY
		...
		tr_moves EATHQUAKE, CURSE, IRON_HEAD, EXPLOSION
	...
	tr_mon 100, CHARIZARD @ FIGY_BERRY
		tr_extra TOUGH_CLAWS 
		tr_moves FIRE PUNCH, BELLY_DRUM, OUTRAGE, EARTHQUAKE
	end_trainer
...
CalGroup:
	...
	tr_mon 100, SMEARGLE @ FOCUS_SASH
		tr_extra OWN_TEMPO 
		tr_moves DRAGON_DANCE, SACRED_FIRE, SPORE, BATON_PASS
	tr_mon 100, TOGEKISS @ CHOICE_SPECS | HISUIAN_FORM
		tr_extra SUPER_LUCK, SHINY 
		tr_moves TRICK, AEROBLAST, NASTY_PLOT, MOONBLAST
	tr_mon 100, AERODACTYL @ LUM_BERRY
		tr_extra ROCK_HEAD
		tr_moves BRAVE_BIRD, AQUA_TAIL, ROCK_SLIDE, EARTHQUAKE
	end_trainer
...
JackyGroup:
	...
	tr_mon 100, SYLVEON @ METRONOME 
		tr_extra PIXILATE
		tr_moves HYPER_BEAM, BODY_SLAM, HEALING_LIGHT, EARTH_POWER
	tr_mon 100, MEW @ WEAK_POLICY
		tr_extra SYNCHRONIZE
		tr_moves ZEN_HEADBUTT, SWORDS_DANCE, DRAIN_PUNCH, TRANSFORM
	end_trainer
