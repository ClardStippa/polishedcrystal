...
AlexGroup:
	...
	tr_mon 100, MISMAGIUS @ CHOICE_SPECS
		tr_extra LEVITATE
		tr_moves TRICK, WILL_O_WISP, SHADOW_BALL, DAZZLINGLEAM
...
ArbyGroup:
	...
	tr_mon 100, CHARIZARD @ RAZOR_CLAW
		...
		tr_moves DRAGON_DANCE, STONE_EDGE, SACRED_FIRE, OUTRAGE
...
endc
	...
	tr_mon 100, UMBREON @ LUM_BERRY
		tr_moves MEAN_LOOK, BATON_PASS, SUCKER_PUNCH, HEALING_LIGHT
	tr_mon 100, ARCANINE @ MENTAL_HERB
		tr_moves FIRE_BLAST, SOLARBEAM, DRAGON_DANCE, BATON_PASS
	tr_mon 100, PARASECT @ FOCUS_SASH
		tr_moves SPORE, LEECH_SEED, SOLARBEAM, DREAM_EATER
	tr_mon 100, NINETAILS @ SHELL_BELL, FEMALE | ALOLAN_FORM
		tr_moves ICE_BEAM, ATTRACT, CONFUSE_RAY, MOONBLAST
	tr_mon 100, LAPRAS @ LEFTOVERS
		tr_moves DRAGON_DANCE, ICE_BEAM, SURF, BODY_SLAM
	tr_mon 100, MEWTWO @ LIFE_ORB
