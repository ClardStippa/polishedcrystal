...
JackyGroup:
	...
	def_trainer 1, "Arby"
	tr_mon 100, PIKACHU @ LIGHT_BALL
		tr_extra STATIC
		tr_moves THUNDER_WAVE, THUNDERBOLT, SURF, REFLECT
	tr_mon 100, VENUSAUR @ FOCUS_SASH
		tr_extra THICK_FAT
		tr_moves SLEEP_POWDER, PETAL_DANCE, SLUDGE_BOMB, GROWTH
	tr_mon 100, BLASTOISE @ QUICK_CLAW
		tr_extra MEGA_LAUNCHER
		tr_moves SHELL_SMASH, MIRROR_COAT, AURA_SPHERE, SURF
	tr_mon 100, CHARIZARD @ LEFTOVERS
		tr_extra TOUGH_CLAWS, SHINY 
		tr_moves DRAGON_DANCE, ANCIENTPOWER, SACRED_FIRE, OUTRAGE
