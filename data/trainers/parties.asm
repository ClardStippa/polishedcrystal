...
AlexGroup:
	...
	tr_mon 100, TOGEKISS @ CHOICE_SPECS
		tr_extra SUPER_LUCK, SHINY 
		tr_moves TRICK, AEROBLAST, NASTY_PLOT, MOONBLAST
...
ArbyGroup:
	...
	tr_mon 100, MEW @ WEAK_POLICY
		...
		tr_moves ZEN_HEADBUTT, DRAGON_DANCE, DRAIN_PUNCH, BATON_PASS
	tr_mon 100, SYLVEON @ METRONOME 
		tr_extra PIXILATE
		tr_moves HYPER_BEAM, BODY_SLAM, HEALINGLIGHT, EARTH_POWER
	end_trainer
...
endc
	...
	tr_mon 100, LUGIA @ BIG_ROOT
		tr_extra MULTISCALE
		tr_moves GIGA_DRAIN, AEROBLAST, ICE_BEAM, CALM_MIND
