...
CarrieGroup:
	...
	tr_mon 100, BUTTERFREE @ FOCUS_SASH
		...
		tr_moves SLEEP_POWDER, DREAM_EATER, REFLECT, U_TURN
	tr_mon 100, STEELIX @ WEAK_POLICY
		tr_extra STURDY, SHINY
		tr_moves CRUNCH, CURSE, IRON_HEAD, EXPLOSION
...
CalGroup:
	...
	tr_mon 100, TYPHLOSION @ CHOICE_SPECS | HISUIAN_FORM
		tr_extra FRISK 
		tr_moves TRICK, WILL_O_WISP, HEX, FIRE_BLAST
	tr_mon 100, AERODACTYL @ LUM_BERRY
		tr_extra ROCK_HEAD
		tr_moves BRAVE_BIRD, BRICK_BREAK, ROCK_SLIDE, EARTHQUAKE
	end_trainer
