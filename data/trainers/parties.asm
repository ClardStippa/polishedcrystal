...
endc
	...
	tr_mon 100, SYLVEON @ WEAK_POLICY, MALE
		tr_extra PIXILATE
		tr_moves HYPER_BEAM, EARTH_POWER, TRICK_ROOM, HEALING_LIGHT
...
endc
	...
	tr_mon 100, UMBREON @ LUM_BERRY, FEMALE
		...
		tr_moves MEAN_LOOK, BATON_PASS, TOXIC, HEALING_LIGHT
	tr_mon 100, ARCANINE @ MENTAL_HERB, MALE
		tr_extra INTIMIDATE
		tr_moves FIRE_BLAST, SOLARBEAM, DRAGON_DANCE, BATON_PASS
	tr_mon 100, PARASECT @ FOCUS_SASH, FEMALE
		tr_extra EFFECT_SPORE
		tr_moves SPORE, LEECH_SEED, SOLARBEAM, DREAM_EATER
