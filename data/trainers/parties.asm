...
AmeliaGroup:
	...
	tr_mon 100, STARMIE @ SHELL_BELL
		tr_extra NATURAL_CURE, SHINY
		tr_moves THUNDER_WAVE, SURF, PSYCHIC, RECOVER
	tr_mon 100, STEELIX @ WEAK_POLICY
		tr_extra STURDY, SHINY
		tr_moves EARTHQUAKE, CRUNCH, IRON_HEAD, EXPLOSION
	tr_mon 100, SNORLAX @ LEFTOVERS
		tr_extra IMMUNITY 
		tr_moves BODY_SLAM, REST, CLOSE_COMBAT, CURSE
	tr_mon 100, ZAPDOS @ LUM_BERRY
		tr_extra DRIZZLE 
		tr_moves THUNDER, ROOST, HURRICANE, AURORA_BEAM
	tr_mon 100, CHARIZARD @ METRONOME
		tr_extra TOUGH_CLAWS 
		tr_moves FIRE_BLAST, DRAGON_DANCE, OUTRAGE, FOCUS_BLAST
	end_trainer
...
AlexGroup:
	...
	tr_mon 100, ARCANINE @ LOADED_DICE, MALE | HISUIAN_FORM
		tr_extra ROCK_HEAD 
		tr_moves SACRED_FIRE, ROCK_BLAST, BULK_UP, WILD_CHARGE
	tr_mon 100, CLODSIRE @ BLACK_SLUDGE
		tr_extra WATER_ABSORB
		tr_moves POISON_JAB, CURSE, MEGAHORN, RECOVER
	tr_mon 100, SMEARGLE @ FOCUS_SASH
		tr_extra OWN_TEMPO 
		tr_moves SWORDS_DANCE, THRASH, SPORE, BATON_PASS
	tr_mon 100, AERODACTYL @ LIFE_ORB
		tr_extra ROCK_HEAD
		tr_moves BRAVE_BIRD, AQUA_TAIL, STONE_EDGE, HONE_CLAWS
	end_trainer
...
ArbyGroup:
	...
	tr_mon 100, BLASTOISE @ QUICK_CLAW
		tr_extra MEGA_LAUNCHER
		tr_moves SHELL_SMASH, MIRROR_COAT, AURA_SPHERE, SURF
	tr_mon 100, CHARIZARD @ RAZOR_CLAW
		tr_extra TOUGH_CLAWS, SHINY 
		tr_moves BELLY_DRUM, STONE_EDGE, SACRED_FIRE, OUTRAGE
	tr_mon 100, PINSIR @ LUM_BERRY
		tr_extra MOXIE 
		tr_moves GLARE, LEECH_LIFE, SWORDS_DANCE, CLOSE_COMBAT
	tr_mon 100, MEW @ WEAK_POLICY
		tr_extra SYNCHRONIZE
		tr_moves PSYCHIC, NASTY_PLOT, AURA_SPHERE, ROOST
	end_trainer
...
endc
	...
	tr_mon 100, DITTO @ LUM_BERRY, MALE
		tr_extra IMPOSTER, SHINY
		tr_moves TRANSFORM
	tr_mon 100, SYLVEON @ WEAK_POLICY, MALE
		tr_extra PIXILATE
		tr_moves HYPER_BEAM, EARTH_POWER, TRICK_ROOM, HEALINGLIGHT
	tr_mon 100, TYRANITAR @ LOADED_DICE, MALE
		tr_extra SAND_STREAM
		tr_moves ROCK_BLAST, DRAGON_DANCE, CRUNCH, CLOSE_COMBAT
	tr_mon 100, LUGIA @ BIG_ROOT, MALE
		tr_extra MULTISCALE
		tr_moves RECOVER, AEROBLAST, ICE_BEAM, CALM_MIND
	tr_mon 100, ENTEI @ MENTAL_HERB, MALE
		tr_extra INNER_FOCUS
		tr_moves SACRED_FIRE, IRON_HEAD, SOLAR_BEAM, EXTREMESPEED
	tr_mon 100, MOLTRES @ FOCUS_SASH, FEMALE | GALARIAN_FORM
		tr_extra BERSERK
...
endc
	...
	def_trainer TUBS, "Tubs"
	tr_mon 100, UMBREON @ LUM_BERRY, FEMALE
		tr_extra MAGIC_GUARD
		tr_moves MEAN_LOOK, BATON_PASS, TOXIC, HEALINGLIGHT
	tr_mon 100, ARCANINE @ MENTAL_HERB, MALE
		tr_extra INTIMIDATE
		tr_moves FIRE_BLAST, SOLAR_BEAM, DRAGON_DANCE, BATON_PASS
	tr_mon 100, PARASECT @ FOCUS_SASH, FEMALE
		tr_extra EFFECT_SPORE
		tr_moves SPORE, LEECH_SEED, SOLAR_BEAM, DREAM_EATER
	tr_mon 100, NINETAILS @ WEAK_POLICY, FEMALE | ALOLAN_FORM
		tr_extra SNOW_WARNING
		tr_moves BLIZZARD, HYPNOSIS, DREAM_EATER, CONFUSE_RAY
	tr_mon 100, LAPRAS @ LEFTOVERS, FEMALE
		tr_extra SHELL_ARMOR, SHINY
		tr_moves DRAGON_DANCE, ICE_BEAM, SURF, BODY_SLAM
	tr_mon 100, MEWTWO @ LIFE_ORB, MALE
		tr_extra INSOMNIA
		tr_moves NASTY_PLOT, PSYSTRIKE, AURA_SPHERE, RECOVER
	end_trainer
