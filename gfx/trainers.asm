...
SECTION "AmeliaPic", ROMX
AmeliaPic: INCBIN "gfx/trainers/amelia.2bpp.lz"

SECTION "AlexPic", ROMX
AlexPic: INCBIN "gfx/trainers/alex.2bpp.lz"

SECTION "ArbyPic", ROMX
ArbyPic: INCBIN "gfx/trainers/arby.2bpp.lz"
